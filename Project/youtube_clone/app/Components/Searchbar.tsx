export const Searchbar = () => {
  ...
  return <div>
            ...
            <form className="max-sm:hidden w-full sm:w-48 lg:w-96 mx-auto">
                ...
                <div className="relative">
                    ...
                    <input type="search" id="search" className="block w-full p-3 ps-9 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-full focus:ring-brand focus:border-brand shadow-xs placeholder:text-body" placeholder="Search" required/>
